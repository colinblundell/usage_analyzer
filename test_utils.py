...
def verify_basic_including_to_included(test_case, including_to_included):
...
def verify_basic_included_to_including(test_case, included_to_including):
...
def verify_complex_including_to_included(test_case, including_to_included):
  including_files = including_to_included.keys()
  including_files.sort()
...
def verify_complex_included_to_including(test_case, included_to_including):
