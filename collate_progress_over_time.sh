...
NEWLINE=$'\n'
progress_over_time=""
for f in `ls data/databases/signin_internals` ; do
  progress_over_time+=`cat data/databases/signin_internals/$f/analyses/$analysis_config/progress_over_time_input.txt`${NEWLINE}
done
