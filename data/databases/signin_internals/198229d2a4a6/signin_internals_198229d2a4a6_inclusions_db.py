{
    ...
    'included_to_including': {
        ...
        'chrome/browser/signin/signin_manager_factory.h': [
            ...
            'chrome/browser/gcm/gcm_profile_service_unittest.cc',
            'chrome/browser/supervised_user/child_accounts/child_account_service_factory.cc',
            'chrome/browser/chromeos/arc/arc_support_host_unittest.cc',
            'chrome/browser/chromeos/login/signin/auth_sync_observer.cc',
            ...
            'chrome/browser/chromeos/arc/arc_play_store_enabled_preference_handler_unittest.cc',
            'chrome/browser/chromeos/extensions/file_manager/private_api_drive.cc',
            'chrome/browser/ui/webui/settings/people_handler.cc',
            'chrome/browser/extensions/updater/chrome_extension_downloader_factory.cc',
            'chrome/browser/ui/search/search_tab_helper_unittest.cc',
        ...
        'components/signin/core/browser/fake_profile_oauth2_token_service.h': [
            ...
            'components/gcm_driver/gcm_account_tracker_unittest.cc',
            'components/invalidation/impl/ticl_invalidation_service_unittest.cc',
            'chrome/browser/chromeos/arc/auth/arc_auth_service_browsertest.cc',
            'components/invalidation/impl/ticl_profile_settings_provider_unittest.cc',
            'components/search_provider_logos/logo_service_impl_unittest.cc',
            'components/browser_sync/profile_sync_test_util.h',
            'chrome/browser/signin/signin_tracker_unittest.cc',
            'services/identity/public/cpp/access_token_fetcher_unittest.cc',
        ...
        'components/signin/core/browser/profile_oauth2_token_service.h': [
            ...
            'chrome/browser/chromeos/extensions/file_manager/private_api_misc.cc',
            'chrome/browser/signin/profile_oauth2_token_service_factory.cc',
            'chrome/browser/metrics/desktop_session_duration/desktop_profile_session_durations_service.cc',
            'chrome/browser/profiles/profiles_state.cc',
            'components/signin/core/browser/account_reconcilor_unittest.cc',
            'components/browser_sync/profile_sync_service_startup_unittest.cc',
            'components/signin/core/browser/signin_manager_unittest.cc',
            ...
            'components/gcm_driver/account_tracker.cc',
        ...
        'components/signin/core/browser/signin_manager.h': [
            ...
            'chrome/browser/android/signin/signin_manager_android.cc',
            'chrome/browser/ui/sync/one_click_signin_sync_observer_unittest.cc',
            'components/gcm_driver/account_tracker.h',
            'components/signin/core/browser/about_signin_internals.h',
    ...
    'repo_commit_date': '2018-06-26',
    'repo_rev': '198229d2a4a6',
    'timestamp (UTC)': '2018-11-23 10:48:56.134866',
